...
export type Formatter<T extends BaseType, IsTransition extends boolean = true> = IsTransition extends true
...
export type LineBarChartProps = {
    ...
    bar: Pick<BarChartProps, 'data' | 'secondaryAxis' | 'primaryAxis' | 'colorByGroup' | 'colors'>;
    duration?: number;
    onRender?: () => void;
...
export type ChartSegment = Selection<SVGGElement, unknown, SVGGElement, undefined>;
...
export type PrimaryAxisLabelSelection = Selection<SVGTextElement, unknown, SVGGElement, undefined>;
...
export interface AxisChart<T extends AxisChartType> extends Chart<T> {
    ...
    primaryAxis: T extends 'bar'
        ? Required<Omit<BarChartProps['primaryAxis'], 'position'>> & { position: Position }
        : Required<AxisChartDefinitions[T]['props']['primaryAxis']>;
    secondaryAxis: T extends 'bar'
        ? Required<Omit<BarChartProps['secondaryAxis'], 'position'>> & { position: Position }
